                ...
                <div className="card card-glass p-8">
                    <div className="flex gap-4 mb-6">
                        <button
                            ...
                            className={`flex-1 py-2 px-4 rounded-md font-semibold transition ${signupMethod === 'email'
                        ...
                        <button
                            ...
                            className={`flex-1 py-2 px-4 rounded-md font-semibold transition ${signupMethod === 'phone'
                                ? 'bg-primary-blue text-white'
                                : 'bg-neutral-200 text-neutral-700'
                                }`}
                        >
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <p className="text-sm text-neutral-500 mb-2">Register as a patient/user. Driver and admin accounts are created by administrators.</p>
                        ...
                        <>
                            ...
                            <div className="form-group">
                                <label className="form-label">Allergies (Optional, comma-separated)</label>
                                <input
                                    type="text"
                                    className="form-input"
